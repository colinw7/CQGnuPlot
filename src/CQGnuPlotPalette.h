...
class CQGnuPlotPalette : public CQGnuPlotObject, public CGnuPlotPalette {
  ...
  Q_PROPERTY(bool   redNegative   READ isRedNegative   WRITE setRedNegative  )
  Q_PROPERTY(int    redModel      READ redModel        WRITE setRedModel     )
  Q_PROPERTY(bool   greenNegative READ isGreenNegative WRITE setGreenNegative)
  Q_PROPERTY(int    greenModel    READ greenModel      WRITE setGreenModel   )
  Q_PROPERTY(bool   blueNegative  READ isBlueNegative  WRITE setBlueNegative )
