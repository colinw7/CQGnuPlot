...
//Q_PROPERTY(CPoint3D position1        READ position1         WRITE setPosition1)
  Q_PROPERTY(bool     logarithmicX     READ isLogarithmicX    WRITE setLogarithmicX)
  Q_PROPERTY(bool     logarithmicY     READ isLogarithmicY    WRITE setLogarithmicY)
  Q_PROPERTY(int      logarithmicBaseX READ logarithmicBaseX  WRITE setLogarithmicBaseX)
  Q_PROPERTY(int      logarithmicBaseY READ logarithmicBaseY  WRITE setLogarithmicBaseY)
