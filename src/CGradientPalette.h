 ...
 public:
  CCubeHelix(const CHSL &a=CHSL( 300.0/360.0, 0.5, 0),
   ...
   a_(a), b_(b) {
    ...
    ah_ = (360*a_.getHue() + 120)*radians;
    bh_ = (360*b_.getHue() + 120)*radians - ah_;
  ...
  void setStart(double r) { start_ = r; }

  double cycles() const { return cycles_; }
  void setCycles(double r) { cycles_ = r; }

  double saturation() const { return saturation_; }
  void setSaturation(double r) { saturation_ = r; }
