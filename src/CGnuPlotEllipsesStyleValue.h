#ifndef CGnuPlotEllipsesStyleValue_H
#define CGnuPlotEllipsesStyleValue_H

#include <CGnuPlotStyleValue.h>
#include <CGnuPlotCoordValue.h>

class CGnuPlotEllipsesStyleValue : public CGnuPlotStyleValue {
 public:
 ...
 public:
  ...
  virtual ~CGnuPlotEllipsesStyleValue() { }

  void init(const CGnuPlotEllipsesStyleValue &v) {
    units_ = v.units_;
